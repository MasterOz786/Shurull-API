              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 w-0 flex-1 pt-0.5">
                  ...
                  <p className="mt-1 text-sm text-gray-400">
                    Your API will be available in approximately 2-3 minutes.
                  </p>
                </div>
                <div className="ml-4 flex flex-shrink-0">
                  <button
                    type="button"
                    className="inline-flex rounded-md bg-gray-800 text-gray-400 hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500"
                    onClick={onClose}
                  >
